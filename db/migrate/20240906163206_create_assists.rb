...
class CreateAssists < ActiveRecord::Migration[7.1]
  def change
    ...
    %I[kill_event_id player_id build_id main_hand_path awakened_weapon_id off_hand_path head_path chest_path feet_path cape_path bag_path
    mount_path potion_path food_path avg_ip kill_fame duo_rating_gain].each do |col|
      add_index :assists, col
    end

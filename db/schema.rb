...
ActiveRecord::Schema[7.1].define(version: 2024_09_06_163630) do
  ...
  create_table "builds", force: :cascade do |t|
    ...
    t.index ["cape_type_path"], name: "index_builds_on_cape_type_path"
    t.index ["chest_type_path"], name: "index_builds_on_chest_type_path"
    ...
    t.index ["feet_type_path"], name: "index_builds_on_feet_type_path"
    t.index ["head_type_path"], name: "index_builds_on_head_type_path"
    ...
    t.index ["main_hand_type_path", "off_hand_type_path", "head_type_path", "chest_type_path", "feet_type_path", "cape_type_path"], name: "index_builds_on_unique_columns", unique: true
    t.index ["main_hand_type_path"], name: "index_builds_on_main_hand_type_path"
    t.index ["off_hand_type_path"], name: "index_builds_on_off_hand_type_path"
  ...
  create_table "kills", force: :cascade do |t|
    ...
    t.index ["damage"], name: "index_kills_on_damage"
    ...
    t.index ["healing"], name: "index_kills_on_healing"
  ...
  add_foreign_key "builds", "cape_types", column: "cape_type_path", primary_key: "path"
  add_foreign_key "builds", "chest_types", column: "chest_type_path", primary_key: "path"
  add_foreign_key "builds", "feet_types", column: "feet_type_path", primary_key: "path"
  add_foreign_key "builds", "head_types", column: "head_type_path", primary_key: "path"
  add_foreign_key "builds", "main_hand_types", column: "main_hand_type_path", primary_key: "path"
  add_foreign_key "builds", "off_hand_types", column: "off_hand_type_path", primary_key: "path"

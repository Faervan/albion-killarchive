...
class AwakenedWeapon < ApplicationRecord
  ...
  belongs_to :attuned_player_id, class_name: 'Player', foreign_key: 'attuned_player_id', inverse_of: :awakened_weapons_attuned
  belongs_to :crafted_player_id, class_name: 'Player', foreign_key: 'crafted_player_id', inverse_of: :awakened_weapons_crafted
  belongs_to :trait0,
